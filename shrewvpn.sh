...
sudo git clone https://github.com/HayfaAbusnina/ike.git; sudo sed -i "s/habusnina/$user/g" /home/ike/source/qikea/moc_qikea.cpp_parameters; sudo sed -i "s/habusnina/$user/g" /home/ike/source/qikec/moc_qikec.cpp_parameters
